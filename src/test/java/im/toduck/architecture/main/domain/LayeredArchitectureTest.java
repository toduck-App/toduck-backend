...
@AnalyzeClasses(packages = "im.toduck.domain", importOptions = {
		...
		LayeredArchitectureTest.ScheduleEventPackageIgnore.class
})
public class LayeredArchitectureTest {
	...
	// schedule.domain.event 패키지 제외를 위한 커스텀 ImportOption
	public static class ScheduleEventPackageIgnore implements ImportOption {
		@Override
		public boolean includes(Location location) {
			return !location.contains("schedule/domain/event");
		}
	}
	...
	@ArchTest
	static final ArchRule 오직_Entity_레이어의_enum_만_DTO_에서_사용될_수_있다 = classes()
			.that()
