...
public class EventsSocialController implements EventsSocialApi {
	...
	public ResponseEntity<ApiResponse<EventsSocialListResponse>> getEventsSocial(
		...
		EventsSocialListResponse response = eventsSocialUseCase.getEventsSocial(userDetails.getUserId());
	...
	public ResponseEntity<ApiResponse<Map<String, Object>>> deleteEventsSocial(
		...
		eventsSocialUseCase.deleteEvents(eventsSocialId, userDetails.getUserId());
